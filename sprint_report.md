...
What's New:
 - Leaderboard hooked up to firebase
 - Google O'Auth Login
 - Workout Tracker
 - Workout Cards (social media aspect)
 - Partially integrated Figma
 - Developed UI for workout tracker page and settings page


 Work Summary
 Our team built off of what we had earlier in our prototype stage, developing crucial backend improvements like a login flow (Google O’Auth -> username selection -> main page), added a “Feed” which has the public leaderboard (hooked up to Firebase), workout cards, and the gym check-in button from earlier. We incorporated a workout tracker to track workout information (separate of the main page).
...
What went well:
We were able to complete a bunch of features and integrate crucial backend + frontend stuff. We did better at splitting up the work between our group members and ensuring each finished tasks.


What we’d like to improve:
We would like to meet more often and stay on the same page: and hold everyone accountable to completing tasks earlier than deadlines so we stay ahead. We’d like to make sure everyone stays active and available


Here are changes we plan to implement in the next sprint:
We would like to meet more often (3 times a week) and implement more features in the first two weeks of the sprint, so we don’t have to rush in the final two and create a higher quality final product.
...
https://github.com/CharlesLiuCool/gymroyale/issues/17
https://github.com/CharlesLiuCool/gymroyale/issues/18
https://github.com/CharlesLiuCool/gymroyale/issues/16
https://github.com/CharlesLiuCool/gymroyale/issues/19
https://github.com/CharlesLiuCool/gymroyale/issues/20
